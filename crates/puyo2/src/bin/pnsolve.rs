...
fn run_search(
    ...
    thread::scope(|scope| {
        ...
        root_condition.dedup_mode = options.dedup_mode;
        ...
        let mut records = worker_outputs
            .into_iter()
...
fn search_job(
    ...
    condition_search.last_callback = Some(Box::new(move |sr: &SearchResult| {
        ...
        output.solutions.push(SolutionRecord {
            root_order: job.root_order,
            local_order,
